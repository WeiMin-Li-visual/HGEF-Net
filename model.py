...
class ContrastiveLoss(nn.Module):
    ...
    def forward(self, anchor, positive, negative):
        ...
        # Use InfoNCE (Noise Contrastive Estimation) loss
...
class GNN_graphpred(torch.nn.Module):
    ...
    def forward(self, *argv):
        ...
        positive_samples = self.gnn(x, edge_index, edge_attr)
        negative_samples = self.gnn(x, edge_index, edge_attr)

        loss = self.contrastive_loss(node_representation, positive_samples, negative_samples)

        return loss, node_representation
